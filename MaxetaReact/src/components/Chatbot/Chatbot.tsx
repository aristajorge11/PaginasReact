  ...
  const handleQuickResponse = (type: string) => {
    switch (type) {
      ...
      case 'membership':
        ...
        break;
      case 'advisor':
        window.open('https://wa.me/51933141678?text=Hola,%20necesito%20ayuda%20en%20MAXETA.', '_blank', 'noopener,noreferrer');
        break;
      default:
        break;
    }
        ...
        {isOpen && (
          ...
          >
            <div className="flex items-center justify-between border-b border-white/10 bg-black px-4 sm:px-5 py-3 sm:py-4">
              <div>
                <h2 className="text-sm sm:text-base font-semibold text-white">Asistente MAXETA</h2>
            ...
            <div className="grid grid-cols-2 gap-2 border-t border-white/10 p-3 sm:grid-cols-2">
              ...
              <a
                href="https://wa.me/51933141678?text=Hola,%20necesito%20ayuda%20en%20MAXETA."
                target="_blank"
