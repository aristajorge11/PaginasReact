        ...
        <>
          ...
          >
            <div className="flex items-center justify-between border-b border-black/10 bg-white px-5 py-5 sm:px-7 sm:py-6">
              ...
              <motion.button type="button" onClick={closeCart} whileHover={{ scale: 1.06 }} whileTap={{ scale: 0.95 }} className="p-2 text-black transition duration-200 hover:bg-black hover:text-white">
                <X size={20} />
              </motion.button>
            </div>
